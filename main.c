...
void EncryptRWithKey(char message[]); //This is the prototype of the function that will rotationally encrpyt a message
...
void EncryptRWithKey(char message[]) {
    ...
    scanf("%d", &Ekey);
        ...
        else 
        {
            ...
            //}
            //message = EncryptRWithKey(message);
            printf("%s", message);
            exit(0);
                    }
